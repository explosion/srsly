...
from srsly.pickle import cloudpickle
from srsly.pickle.cloudpickle import _is_dynamic
from srsly.pickle.cloudpickle import _make_empty_cell, cell_set
...
class CloudPickleTest(unittest.TestCase):
    ...
    #    PyTest is wrapping sys.stderr, which screws this up
    #    out1 = sys.stderr
    ...
    def test_dynamic_modules_globals(self):
        ...
        import pickle
        from srsly.pickle.cloudpickle import _dynamic_modules_globals
        import gc
    ...
    def test_dynamic_pytest_module(self):
        ...
        # serializable.
        from srsly.pickle.cloudpickle import CloudPickler
    ...
    def test_interactively_defined_global_variable(self):
        ...
        code_template = """\
        from testutils import subprocess_pickle_echo
        from srsly.pickle.cloudpickle import dumps, loads
